...
import static com.royalcars.jd.dealershipapp.IssueInformationFragment.dateDay;
import static com.royalcars.jd.dealershipapp.IssueInformationFragment.dateMonth;
import static com.royalcars.jd.dealershipapp.IssueInformationFragment.dateYear;
import static com.royalcars.jd.dealershipapp.IssueInformationFragment.hour;
import static com.royalcars.jd.dealershipapp.IssueInformationFragment.min;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_homepage) {
            ...
            if(selectedFragment == null) {
               // Toast.makeText(this, "El Paso es 1", Toast.LENGTH_SHORT).show();
                transaction.replace(R.id.content, new MainFragment(), "homepage");
                transaction.addToBackStack(null);
            } else if(!selectedFragment.isVisible()) {
               // Toast.makeText(this, "El paso es 2", Toast.LENGTH_SHORT).show();
                transaction.replace(R.id.content, new MainFragment(), "homepage");
